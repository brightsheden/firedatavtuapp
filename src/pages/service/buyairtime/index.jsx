  ...
  return (
   ...
   <TopBar title='Buy Airtime'/>
      ...
      <div className="bg-white p-4 md:p-8 rounded md:shadow-md w-full md:w-96">
        <h2 className="text-2xl hidden md:block font-semibold mb-6 text-center">Airtime Purchase</h2>
        ...
        <option>9mobile</option>
          ...
          <button
            type="submit"
            className="btn w-full bg-primary hover:opacity-80 text-white px-4 py-2 rounded-lg focus:outline-none "
          >
            Purchase
          </button>
        </form>
